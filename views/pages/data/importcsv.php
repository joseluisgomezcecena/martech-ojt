...
<h1 class="h3 mb-4 text-gray-800">Import SOP Data </h1>
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <h6 class="m-0 font-weight-bold text-default">Choose multiple files</h6>
    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <h6 class="m-0 font-weight-bold text-default">Files</h6>
