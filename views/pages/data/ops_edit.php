...
<h1 class="h3 mb-4 text-gray-800">Edit Operation For: <span class="text-primary"><?php echo $row['cell_name']; ?></span>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <h6 class="m-0 font-weight-bold text-default">Update Operation</h6>
                ...
                <div id="profile-data" class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group ">
                            <button id="edit_profile1" name="edit_op" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                <i class="fas fa-save fa-sm text-white-50"></i>&nbsp;&nbsp;Update Operation
                            </button>
                        </div>
